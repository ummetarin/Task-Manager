...
const Register = () => {
    ...
    return (
        <div>
        <div className="flex md:flex-row flex-col  justify-around py-10 ">
         <div className="flex justify-center ">
         <div className="form-container bg-pink-200  w-[400px] ">
       ...
       <p className="sign-up-label">
         Dont have an account?<Link className="text-red-500 font-bol" to={'/'}>Login</Link>
       </p>
       <div className="buttons-container">
         ...
         c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
           ...
           <div>
             <img className="h-[350px] w-[400px] mt-16" src="https://i.ibb.co/FzGcrrp/isometric-time-management-concept-illustrated-52683-55534.jpg" alt="" />
           </div>
                         </div>
             </div>
